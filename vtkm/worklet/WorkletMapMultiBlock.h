...
//  this software.
//============================================================================
#ifndef vtk_m_worklet_WorkletMapMultiBlock_h
#define vtk_m_worklet_WorkletMapMultiBlock_h
...
/// same size.
///
class WorkletMapMultiBlock : public vtkm::worklet::internal::WorkletBase
{
public:
  ...
  struct MultiBlockIn : vtkm::cont::arg::ControlSignatureTagBase {
  ...
  ///
  template<typename TypeList = AllTypes>
  struct MultiBlockOut : vtkm::cont::arg::ControlSignatureTagBase {
    typedef vtkm::cont::arg::TypeCheckTagArray<TypeList> TypeCheckTag;
  ...
  ///
  template<typename TypeList = AllTypes>
  struct MultiBlockInOut : vtkm::cont::arg::ControlSignatureTagBase {
    typedef vtkm::cont::arg::TypeCheckTagArray<TypeList> TypeCheckTag;
