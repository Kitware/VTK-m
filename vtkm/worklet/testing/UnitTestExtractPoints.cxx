...
public:
  ...
  void TestUniformByBox() const
  {
    ...
    // Implicit function
    vtkm::Vec<vtkm::Float64, 3> minPoint(1.0, 1.0, 1.0);
    vtkm::Vec<vtkm::Float64, 3> maxPoint(3.0, 3.0, 3.0);
  ...
  void TestUniformBySphere() const
  {
    ...
    // Implicit function
    vtkm::Vec<vtkm::Float64, 3> center(2, 2, 2);
    vtkm::Float64 radius(1.8);
  ...
  void TestExplicitByBox() const
  {
    ...
    // Implicit function
    vtkm::Vec<vtkm::Float64, 3> minPoint(0.0, 0.0, 0.0);
    vtkm::Vec<vtkm::Float64, 3> maxPoint(1.0, 1.0, 1.0);
    vtkm::Box box(minPoint, maxPoint);
