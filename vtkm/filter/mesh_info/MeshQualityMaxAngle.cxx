...
struct MaxAngleWorklet : MeshQualityWorklet<MaxAngleWorklet>
{
  ...
  {
    return vtkm::worklet::cellmetrics::CellMaxAngleMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
vtkm::cont::DataSet MeshQualityMaxAngle::DoExecute(const vtkm::cont::DataSet& input)
{
