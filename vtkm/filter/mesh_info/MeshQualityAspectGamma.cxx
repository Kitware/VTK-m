...
struct AspectGammaWorklet : MeshQualityWorklet<AspectGammaWorklet>
{
  ...
  {
    return vtkm::worklet::cellmetrics::CellAspectGammaMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
vtkm::cont::DataSet MeshQualityAspectGamma::DoExecute(const vtkm::cont::DataSet& input)
{
