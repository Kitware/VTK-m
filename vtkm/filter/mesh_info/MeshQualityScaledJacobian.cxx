...
struct ScaledJacobianWorklet : MeshQualityWorklet<ScaledJacobianWorklet>
{
  ...
  {
    return vtkm::worklet::cellmetrics::CellScaledJacobianMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
vtkm::cont::DataSet MeshQualityScaledJacobian::DoExecute(const vtkm::cont::DataSet& input)
{
