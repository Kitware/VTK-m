...
struct ConditionWorklet : MeshQualityWorklet<ConditionWorklet>
{
  ...
  {
    return vtkm::worklet::cellmetrics::CellConditionMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
vtkm::cont::DataSet MeshQualityCondition::DoExecute(const vtkm::cont::DataSet& input)
{
