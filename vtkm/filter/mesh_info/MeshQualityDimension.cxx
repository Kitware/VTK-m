...
struct DimensionWorklet : MeshQualityWorklet<DimensionWorklet>
{
  ...
  {
    return vtkm::worklet::cellmetrics::CellDimensionMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
vtkm::cont::DataSet MeshQualityDimension::DoExecute(const vtkm::cont::DataSet& input)
{
