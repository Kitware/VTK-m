...
struct AspectRatioWorklet : MeshQualityWorklet<AspectRatioWorklet>
{
  ...
  {
    return vtkm::worklet::cellmetrics::CellAspectRatioMetric<OutType>(numPts, pts, shape, ec);
  }
};
...
vtkm::cont::DataSet MeshQualityAspectRatio::DoExecute(const vtkm::cont::DataSet& input)
{
